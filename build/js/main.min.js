...
/* harmony import */ var _modules_check_submit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/check-submit */ "./js/modules/check-submit.js");
/* harmony import */ var _modules_toggle_nav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/toggle-nav */ "./js/modules/toggle-nav.js");
/* harmony import */ var _modules_remove_nojs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/remove-nojs */ "./js/modules/remove-nojs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_remove_nojs__WEBPACK_IMPORTED_MODULE_4__["deleteNoJS"])();
  Object(_modules_check_submit__WEBPACK_IMPORTED_MODULE_2__["changeSubmitState"])();
  Object(_modules_toggle_nav__WEBPACK_IMPORTED_MODULE_3__["navToggle"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
/***/ "./js/modules/check-submit.js":
/*!************************************!*\
  !*** ./js/modules/check-submit.js ***!
  \************************************/
/*! exports provided: changeSubmitState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeSubmitState", function() { return changeSubmitState; });
var checkBox = document.querySelector('#personal-data-agreement');
var submit = document.querySelector('#submit');

var isCheckBoxChecked = function isCheckBoxChecked() {
  return checkBox.checked;
};

var changeSubmitState = function changeSubmitState() {
  if (checkBox || submit) {
...
/***/ "./js/modules/remove-nojs.js":
/*!***********************************!*\
  !*** ./js/modules/remove-nojs.js ***!
  \***********************************/
/*! exports provided: deleteNoJS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deleteNoJS", function() { return deleteNoJS; });
/* harmony import */ var _utils_elements__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/elements */ "./js/utils/elements.js");


var deleteNoJS = function deleteNoJS() {
  if (_utils_elements__WEBPACK_IMPORTED_MODULE_0__["navBlock"].classList.contains('nav-block--nojs')) {
    _utils_elements__WEBPACK_IMPORTED_MODULE_0__["navBlock"].classList.remove('nav-block--nojs');
  }
};
...
var checkLinkClick = function checkLinkClick(evt) {
  if (evt.target.matches('a')) {
    closeNav();
  }
};

var checkOverlayClick = function checkOverlayClick() {
  closeNav();
};

var openNav = function openNav() {
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["navBlock"].classList.add('nav-block--opened');
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["logoMobile"].style.opacity = 0;
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["mainScreen"].style.opacity = 0;
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["overlay"].classList.add('overlay');
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["pageBody"].classList.add('stop-scrolling');
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["overlay"].addEventListener('click', checkOverlayClick, false);
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["navBlock"].addEventListener('click', checkLinkClick, false);
};

var closeNav = function closeNav() {
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["navBlock"].classList.remove('nav-block--opened');
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["logoMobile"].style.opacity = 1;
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["mainScreen"].style.opacity = 1;
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["overlay"].classList.remove('overlay');
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["pageBody"].classList.remove('stop-scrolling');
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["navBlock"].removeEventListener('click', checkLinkClick, false);
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["overlay"].removeEventListener('click', checkOverlayClick, false);
};

var navToggle = function navToggle() {
  _utils_elements__WEBPACK_IMPORTED_MODULE_0__["toggle"].addEventListener('click', function () {
    if (_utils_elements__WEBPACK_IMPORTED_MODULE_0__["navBlock"].classList.contains('nav-block--opened')) {
      closeNav();
    } else {
      openNav();
    }
...
/*!******************************!*\
  !*** ./js/utils/elements.js ***!
  \******************************/
/*! exports provided: toggle, navBlock, logoMobile, overlay, mainScreen, pageBody */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggle", function() { return toggle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "navBlock", function() { return navBlock; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "logoMobile", function() { return logoMobile; });
...
var toggle = document.querySelector('.nav-block__toggle-wrapper');
var navBlock = document.querySelector('.nav-block');
var logoMobile = document.querySelector('.logo--main-nav-mobile');
